...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  6 11:13:08 2022
...
ds_weights = compute_interpolation_weights(
    src_graph=Healpix16,
    dst_graph=Healpix8,
    method="conservative",
...
ds_weights_back = compute_interpolation_weights(
    src_graph=Healpix8,
    dst_graph=Healpix16,
    method="conservative",
    normalization="fracarea",
...
ds_weight_high_res = compute_interpolation_weights(
    src_graph=Healpix100km,
    dst_graph=Healpix32,
    method="conservative",
    normalization="fracarea",
)
