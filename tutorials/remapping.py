...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  6 11:14:43 2022
...
ds_Healpix_64_notime = xr.open_dataset(
    os.path.join(sample_dir, "Healpix64_sample_notime.nc")
)
ds_Healpix_64_time = xr.open_dataset(
    os.path.join(sample_dir, "Healpix64_sample_2timesteps.nc")
)
ds_Healpix_16_notime = xr.open_dataset(
    os.path.join(sample_dir, "Healpix16_sample_notime.nc")
)
ds_Healpix_16_time = xr.open_dataset(
    os.path.join(sample_dir, "Healpix16_sample_2timesteps.nc")
)
...
ds_Healpix8 = remap_dataset(
    src_ds=ds_Healpix_16_time,
    src_graph=Healpix16,
    dst_graph=Healpix8,
    method="conservative",
...
ds_Healpix16_back = remap_dataset(
    src_ds=ds_Healpix8,
    src_graph=Healpix8,
    dst_graph=Healpix16,
    method="conservative",
...
### Check conservation
# TODO
ds_Healpix8_back = remap_dataset(
    src_ds=ds_Healpix16_back,
    src_graph=Healpix16,
    dst_graph=Healpix8,
    method="conservative",
    normalization="fracarea",
...
ds_Healpix8_tmp = remap_dataset(
    src_ds=ds_Healpix_64_time,
    src_graph=Healpix64,
    dst_graph=Healpix8,
    method="conservative",
    normalization="fracarea",
...
ds_Healpix8_notime = remap_dataset(
    src_ds=ds_Healpix_16_notime,
    src_graph=Healpix16,
    dst_graph=Healpix8,
    method="conservative",
    normalization="fracarea",
...
ds_Healpix8_time = remap_dataset(
    src_ds=ds_Healpix_16_time,
    src_graph=Healpix16,
    dst_graph=Healpix8,
    method="conservative",
...
dst_ds = remap_dataset(
    src_ds=src_ds_no_bnds,
    src_graph=Healpix16,
    dst_graph=Healpix8,
    method="conservative",
    normalization="fracarea",
